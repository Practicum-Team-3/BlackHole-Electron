const nodes = [
  { id: 'VM-B1', group: 0, label: 'VM-B1', level: 2 },
  { id: 'VM-B2', group: 0, label: 'VM-B2', level: 2 },
  { id: 'VM-B3', group: 0, label: 'VM-B3', level: 2 },
  { id: 'VM-Worm', group: 0, label: 'VM-Worm', level: 1 }
]


const links = [
  { target: 'VM-B1', source: 'VM-Worm', strength: 0.1 },
  { target: 'VM-B2', source: 'VM-Worm', strength: 0.1 },
  { target: 'VM-B3', source: 'VM-Worm', strength: 0.1 },
]

const width = $('svg').innerWidth()
const height = $('svg').innerHeight()
